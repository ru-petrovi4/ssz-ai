...
namespace Ssz.AI.Models
{
    public class Model10
    {
        ...
        {
            Cortex_Simplified.MiniColumn maxMemoryMiniColumn = Cortex.CenterMiniColumn!;
        ...
        public VisualizationWithDesc[] GetImageWithDescs1(double positionK, double angle)
        {
            ...
            MonoInput.AddValueHash(0.5f, DetectorsActivationHash);
        ...
        public VisualizationWithDesc[] GetImageWithDescs2()
        {
            ...
            var detectorsActivationBitmap = Visualisation.GetBitmapFromActivatedDetectors(Cortex.SubArea_Detectors.Where(d => d.Temp_IsActivated).ToList());
        ...
        public void GeneratePinwheel(Random random)
        {
            foreach (int mc_index in Enumerable.Range(0, Cortex.SubArea_MiniColumns.Length))
            {
                ...
                float angleNormalized = MathF.Sqrt(dx * dx + dy * dy) / (float)Cortex.SubArea_MiniColumns_Radius;
            ...
            )
        {
            ...
            for (; ; )
            {
                ...
                CalculateDetectorsAndActivityAndSuperActivity((float)random.NextDouble(), MonoInput.MonoInputItems[memory.PictureInputIndex].GradientMatrix, activitiyMaxInfo);
            ...
            bool reorderMemoriesPeriodically)
        {
            ...
            CalculateDetectorsAndActivityAndSuperActivity((float)random.NextDouble(), gradientMatrix, activitiyMaxInfo);
        ...
        public class ModelConstants : IConstantsObsolete
        {
            ...
            public int AngleRangeDegreeMax { get; set; } = 360;
