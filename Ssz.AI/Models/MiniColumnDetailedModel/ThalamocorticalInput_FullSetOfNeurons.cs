...
public sealed class ThalamocorticalInput_FullSetOfNeurons
{
    // ----------------------------------------------------------
    ...
    ///
    public readonly ThalamocorticalAxon_FullSetOfNeurons[] ThalamocorticalAxons;

    public readonly ThalamocorticalAxon_FullSetOfNeurons[] Top200_M_P_ThalamocorticalAxons;
    ...
    public ThalamocorticalInput_FullSetOfNeurons(Random random, float columnRadiusUm, float columnHeightUm)
    {
        FastList<ThalamocorticalAxon_FullSetOfNeurons> thalamocorticalAxons = new (TotalAxonCount);
        FastList<ThalamocorticalAxon_FullSetOfNeurons> m_P_ThalamocorticalAxons = new(TotalAxonCount);
        ...
        {
            var axon = ThalamocorticalAxon_FullSetOfNeurons.Generate(
