...
namespace Ssz.AI.Models
{
    ...
    //        _bottleneckItems = new DenseTensor<BottleneckItem>(new BottleneckItem[_bottleneckSize]);            

    //        // Инициализация весов и смещений
    //        _state_WeightsEncoder = CreateRandomMatrixFloat(_inputSize, _bottleneckSize);
    //        _state_BiasesEncoder = new float[_bottleneckSize];
    //        _state_WeightsDecoder = CreateRandomMatrixFloat(_bottleneckSize, _inputSize);
    //        _state_BiasesDecoder = new float[_inputSize];
    //    }
    ...
    //    private DenseTensor<BottleneckItem> _bottleneckItems = null!;
    ...
    //        public float[] State_WeightsEncoder;
    //        public float[] State_WeightsDecoder;
    //    }
    //}
}
